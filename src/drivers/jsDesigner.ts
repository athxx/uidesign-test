...
export class JsDesignerDriver extends TestDriver {
  ...
  async testMoveSelectAll(url: string, options: MoveSelectAllOptions) {
    ...
    await this.recordPerformance(page, testFn, {
      screenshots: true,
      filename: 'jsDesigner-move-select-all.json',
    })
  }
  ...
  async testMoveForSelectShapes(url: string, options: MoveSelectAllOptions) {
    ...
    await this.recordPerformance(page, testFn, {
      screenshots: true,
      filename: 'jsDesigner-move-for-select-shapes.json',
    })
  }
  ...
  async testWheelZoom(url: string) {
    ...
    await this.recordPerformance(page, testFn, {
      screenshots: true,
      filename: 'jsDesigner-wheel-zoom.json',
    })
  }
